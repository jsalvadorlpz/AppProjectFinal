...
public class RecyclerAdapterRecomendados extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    //constructor
    public RecyclerAdapterRecomendados(Context context, List<CreditResults.Cast> listaActores, Integer id,String titulo,String path){
    ...
    public void updateDataRecomendods(List<CreditResults.Cast> newitems,Integer id,String titulo,String path) {
        listaActores.clear();
